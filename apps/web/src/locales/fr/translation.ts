export const fr = {
  ...
  auth: {
    forgot: {
      ...
      successDesc: "Vérifiez votre boîte de réception pour le lien de réinitialisation.",
      errorTitle: "Erreur",
      errorDesc: "Échec de l'envoi de l'e-mail. Veuillez réessayer.",
    ...
    reset: {
      ...
      successDesc: "Votre mot de passe a été modifié. Vous pouvez maintenant vous connecter.",
      errorTitle: "Erreur",
      errorDesc: "Échec de la réinitialisation. Veuillez réessayer.",
      mismatchTitle: "Les mots de passe ne correspondent pas",
      mismatchDesc: "Veuillez vous assurer que les deux mots de passe sont identiques.",
      missingToken: "Jeton manquant. Veuillez utiliser le lien reçu par e-mail."
    }
  },
  common: {
    cancel: "Annuler",
  ...
  services: {
    pageTitle: "Services & Contrats",
    pageSubtitle: "Gérer les prestataires, contrats et le personnel",
    loading: "Chargement des services…",
    loadError: "Impossible de charger les services.",
    noServicesYet: "Aucun service pour le moment.",
    addFirstService: "Ajoutez votre premier prestataire de services pour commencer.",
    createService: "Ajouter un service",
    editService: "Modifier le service",
    providerName: "Nom du prestataire",
    serviceType: "Type de service",
    serviceTypePlaceholder: "Sélectionner un type…",
    ...
    skipAndSave: "Ignorer et enregistrer",
    next: "Suivant",
    back: "Retour",
    cancel: "Annuler",
    confirm: "Confirmer",
    ...
    totalContract: "Montant total du contrat",
    paid: "Payé",
    remaining: "Restant",
    ...
    confirmDeleteContractDesc: "Tous les enregistrements de paiement seront perdus.",
    confirmUpdate: "Enregistrer les modifications ?",
    confirmUpdateDesc: "Les détails du contrat seront mis à jour.",
    noContractsYet: "Aucun contrat pour le moment.",
    attachFile: "Joindre un fichier",
    clickToAttach: "Cliquer pour joindre",
    confirmRemoveFile: "Supprimer ce fichier ?",
    confirmRemoveFileDesc: "Le fichier sera définitivement supprimé.",
    amount: "Montant",
    staffTracking: "Suivi du personnel",
    trackStaff: "Suivi du personnel",
    trackStaffDesc: "Enregistrer les entrées et sorties du personnel sur site.",
    assignStaff: "Assigner du personnel",
    selectStaff: "Sélectionner le personnel",
    selectStaffPlaceholder: "Rechercher du personnel…",
    createStaff: "Créer un membre du personnel",
    createStaffButton: "Créer personnel",
    deleteStaff: "Supprimer membre",
    deleteStaffTitle: "Supprimer ce membre du personnel ?",
    deleteStaffDesc: "Ce membre du personnel sera définitivement supprimé.",
    staffCreatedSuccessfully: "Membre du personnel créé.",
    staffDeleted: "Membre du personnel supprimé.",
    checkIn: "Entrée",
    checkOut: "Sortie",
    staffCheckedIn: "Entrée enregistrée.",
    staffCheckedOut: "Sortie enregistrée.",
    ...
    documentsFor: "Documents pour {{contract}}",
    assignStaffDesc: "Assigner du personnel à {{serviceName}}",
    ...
    createStaffHint: "Ajouter un nouveau membre du personnel à ce service.",
    noStaffAssigned: "Aucun personnel affecté à ce service.",
    allStaff: "Tout le personnel",
    staffOnSite: "Sur site",
    staffOffSite: "Hors site",
    sessionDuration: "Durée",
    noName: "Sans nom"
  },
  serviceAnalytics: {
    title: "Analytiques des services",
    subtitle: "Dépenses contractuelles et performance des prestataires",
    loading: "Chargement des statistiques…",
    kpi: {
    ...
    charts: {
      paidVsRemaining: "Payé vs Restant",
      paid: "Payé",
      remaining: "Restant",
      paymentProgress: "Progression des paiements"
    }
