export const en: typeof import('../ar/translation').ar = {
  errors: {
    title: {
      error: "Error",
      warning: "Warning",
  ...
  services: {
    ...
    assignStaffDesc:       "Select the staff members assigned to {{serviceName}}",
    noStaffFound:          "No staff members found in the organization.",
    ...
    documentsFor:          "Files for contract: {{contract}}",
    clickToAttach:         "Click to attach files",
    confirm:               "Confirm",
    confirmUpdate:         "Are you sure you want to update?",
    confirmUpdateDesc:     "This action will modify the data.",
    confirmRemoveFile:     "Are you sure you want to remove this file?",
    confirmRemoveFileDesc: "This action cannot be undone.",
    ...
    confirmDeleteContractDesc: "This action cannot be undone.",
    trackStaff:            "Track Staff",
    staffTracking:         "Staff Tracking",
    trackStaffDesc:        "Manage staff check-ins and check-outs",
    selectStaff:           "Select staff member",
    selectStaffPlaceholder:"Select a staff...",
    checkIn:               "Check In",
    checkOut:              "Check Out",
    in:                    "In",
  ...
  conflict: {
    ...
    paidExceedsAmount: "The paid amount cannot exceed the total contract amount",
  },
  validation: {
    session:      { alreadyCheckedIn: "Staff is already checked in and hasn't checked out yet." },
